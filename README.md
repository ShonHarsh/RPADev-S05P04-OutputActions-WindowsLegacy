...
**GitHub:** https://github.com/ShonHarsh/RPADev-S05P04-OutputActions-WindowsLegacy

### Sample Output

```sh
The weather status for the location.
```
...
```sh
git clone https://github.com/ShonHarsh/RPADev-S05P04-OutputActions-WindowsLegacy
```
